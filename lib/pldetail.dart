...
class PlDeail extends StatefulWidget {
  final AsyncSnapshot snapshot;
  final int index;

  const PlDeail({required this.snapshot, required this.index});

  @override
  State<PlDeail> createState() => _PlDeailState();
}

class _PlDeailState extends State<PlDeail> {
                              ...
                              child: IconButton(
                                  ...
                                  icon: Icon(
                                      widget.snapshot.data[widget.index]
                                          ...
                                          : Icons.favorite,
                                      color: widget.snapshot.data[widget.index]
                                              .favoriteCheck
                                          ? null
                                          : Colors.red),
                                  onPressed: () {
  ...
  void updateFavorite() async {
    ...
    title2 = widget.snapshot.data[widget.index].playListKey;
    await playListNetworkRepository.updateFavorite(
        favoriteTwo, "$title2", []).then((value) => {setState(() {})});
  }
